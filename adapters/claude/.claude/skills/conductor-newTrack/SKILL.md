...
### 2.4 Skill Recommendation (Claude Code-Safe)

1. **Analyze Needs:**
    - Check for a skill catalog at `conductor/skills/catalog.md`, `${CODEX_HOME:-$HOME/.claude}/conductor/skills/catalog.md`, or `~/.claude/conductor/skills/catalog.md`.
...
3. **Apply Installed Skills:**
    ...
    - If the user installs or adds new skills, ask them to restart/reload Claude Code skills if their environment requires it before implementation.

...
3. **Load Track Context:**
    ...
    d. **Activate Relevant Claude Code Skills:**
       - Check for installed skills in repo-local `.claude/skills/`.
       - Check global skills in `${CODEX_HOME:-$HOME/.claude}/skills/` and `~/.claude/skills/`.
       - If `conductor/skills/catalog.md` or `${CODEX_HOME:-$HOME/.claude}/conductor/skills/catalog.md` exists, read it as a recommendation catalog.

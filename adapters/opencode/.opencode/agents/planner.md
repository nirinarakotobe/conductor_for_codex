...
### 2.4 Skill Recommendation (OpenCode-Safe)

1. **Analyze Needs:**
    - Check for a skill catalog at `conductor/skills/catalog.md`, `${CODEX_HOME:-$HOME/.opencode}/conductor/skills/catalog.md`, or `~/.opencode/conductor/skills/catalog.md`.
...
3. **Apply Installed Skills:**
    ...
    - If the user installs or adds new skills, ask them to restart/reload OpenCode skills if their environment requires it before implementation.

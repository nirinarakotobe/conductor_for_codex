...
3. **Load Track Context:**
    ...
    d. **Activate Relevant OpenCode Skills:**
       - Check for installed skills in repo-local `.opencode/skills/`.
       - Check global skills in `${CODEX_HOME:-$HOME/.opencode}/skills/` and `~/.opencode/skills/`.
       - If `conductor/skills/catalog.md` or `${CODEX_HOME:-$HOME/.opencode}/conductor/skills/catalog.md` exists, read it as a recommendation catalog.

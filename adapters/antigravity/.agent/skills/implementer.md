...
3. **Load Track Context:**
    ...
    d. **Activate Relevant Antigravity Skills:**
       - Check for installed skills in repo-local `.agent/skills/`.
       - Check global skills in `${CODEX_HOME:-$HOME/.agent}/skills/` and `~/.agent/skills/`.
       - If `conductor/skills/catalog.md` or `${CODEX_HOME:-$HOME/.agent}/conductor/skills/catalog.md` exists, read it as a recommendation catalog.

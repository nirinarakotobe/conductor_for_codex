...
### 2.4 Skill Recommendation (Antigravity-Safe)

1. **Analyze Needs:**
    - Check for a skill catalog at `conductor/skills/catalog.md`, `${CODEX_HOME:-$HOME/.agent}/conductor/skills/catalog.md`, or `~/.agent/conductor/skills/catalog.md`.
...
3. **Apply Installed Skills:**
    ...
    - If the user installs or adds new skills, ask them to restart/reload Antigravity skills if their environment requires it before implementation.
